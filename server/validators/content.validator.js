...
export const createContentValidator = [
  ...
  body("polaroidItems").optional().isArray(),
  body("polaroidItems.*.image").optional().isString(),
  body("polaroidItems.*.heading").optional().isLength({ max: 120 }),
  body("polaroidItems.*.tagline").optional().isLength({ max: 300 }),
  body("polaroidItems.*.align").optional().isIn(["left", "right"]),
